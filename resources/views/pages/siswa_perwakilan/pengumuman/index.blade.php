...
<div class="row">
    <div class="col-md-12">
        <a href="{{ route('siswa_perwakilan.pengumuman.arsip') }}" class="btn btn-outline-secondary btn-sm mb-3">
        ...
        <div class="card mb-5 shadow-lg border-0 overflow-hidden">
            ...
            <div class="card-body bg-primary text-white p-4">
                ...
                <a href="{{ route('siswa_perwakilan.pengumuman.show', $featured->id) }}" class="btn btn-light btn-sm rounded-pill">
