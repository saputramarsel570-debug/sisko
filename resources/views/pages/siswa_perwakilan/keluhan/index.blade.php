    ...
    <div class="card shadow-sm border-0 mb-4 rounded-4">
      <div class="card-body d-flex flex-wrap align-items-center gap-3">
        ...
        <div class="d-flex align-items-center gap-2 flex-wrap">
          ...
          <a href="{{ route('siswa_perwakilan.keluhan.index', array_filter(['kategori' => 'Keluhan', 'status' => $status])) }}"
             class="btn btn-danger {{ $kategori == 'Keluhan' ? 'disabled' : '' }}">
            <i class="ti ti-alert-circle"></i> Keluhan
          </a>

          <a href="{{ route('siswa_perwakilan.keluhan.index', array_filter(['kategori' => 'Saran', 'status' => $status])) }}"
        ...
        <div class="d-flex align-items-center gap-2 flex-wrap ms-auto">
          ...
          <a href="{{ route('siswa_perwakilan.keluhan.index', array_filter(['kategori' => $kategori, 'status' => 'pending'])) }}"
             class="btn btn-warning  {{ $status == 'pending' ? 'disabled' : '' }}">
            <i class="ti ti-clock"></i> Pending
          </a>

          <a href="{{ route('siswa_perwakilan.keluhan.index', array_filter(['kategori' => $kategori, 'status' => 'proses'])) }}"
             class="btn btn-info  {{ $status == 'proses' ? 'disabled' : '' }}">
            <i class="ti ti-loader-2"></i> Proses
          </a>

          <a href="{{ route('siswa_perwakilan.keluhan.index', array_filter(['kategori' => $kategori, 'status' => 'selesai'])) }}"
