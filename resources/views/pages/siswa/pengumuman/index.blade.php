    ...
    <div class="col-md-12">
        ...
        <div class="card mb-5 shadow-lg border-0">
            <div class="card-body bg-primary text-white rounded p-4">
                ...
                <a href="{{ route('siswa.pengumuman.show', $featured->id) }}" class="btn btn-light btn-sm">
                ...
                <div class="col-md-4 mb-4">
                    <div class="card h-100 shadow-sm border-0 hover-shadow">
                        <div class="card-body">
                            ...
                            <a href="{{ route('siswa.pengumuman.show', $item->id) }}" class="btn btn-outline-primary btn-sm">
