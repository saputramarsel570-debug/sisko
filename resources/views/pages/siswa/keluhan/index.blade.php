...
<div class="row">
  <div class="col-md-12">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
      ...
      <a href="{{ route('siswa.keluhan.create') }}" class="btn btn-primary shadow-sm">
          ...
          <div class="card shadow-sm border-0 h-100 rounded-4 overflow-hidden hover-card">
            ...
            <div class="card-footer bg-white border-0 d-flex justify-content-between align-items-center flex-wrap gap-2">
              <div class="d-flex gap-2">
                <a href="{{ route('siswa.keluhan.show', $item->id) }}" class="btn btn-primary">
                  <i class="ti ti-eye"></i> Lihat
                </a>
                @if($item->status == 'pending')
                  <a href="{{ route('siswa.keluhan.edit', $item->id) }}" class="btn btn-warning ">
                    <i class="ti ti-edit"></i> Edit
                  </a>
                  <a href="javascript:;" onclick="actionDelete('{{ route('siswa.keluhan.destroy', $item->id) }}')"
