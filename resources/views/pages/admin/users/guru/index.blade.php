...
@endif
        ...
        <div class="card shadow-lg border-0 rounded-4">
            <div class="card-header d-flex justify-content-between align-items-center bg-primary text-white rounded-top-4">
                <h4 class="mb-0 fw-bold"><i class="ti ti-school"></i> Kelola Guru</h4>
                <div>
                    <a href="{{ route('admin.guru.create') }}" class="btn btn-light btn-sm me-2">
                        <i class="ti ti-plus"></i> Tambah Guru
                    </a>
                    <a href="{{ route('admin.guru.export') }}" class="btn btn-success btn-sm me-2">
                        <i class="ti ti-download"></i> Export
                    </a>
                    <a href="{{ route('admin.guru.template') }}" class="btn btn-success btn-sm me-2">
            ...
            <div class="card-body">
                ...
                <div class="collapse mb-3" id="importForm">
                    <div class="card card-body border rounded-3">
                        <form action="{{ route('admin.guru.import') }}" method="POST" enctype="multipart/form-data" class="row g-2 align-items-center">
                            @csrf
                            <div class="col">
                    ...
                    <tbody>
                        @forelse($guru as $index => $item)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('admin.guru.show', $item->id) }}" class="btn btn-sm btn-info">
                                        <i class="ti ti-eye"></i>
                                    </a>
