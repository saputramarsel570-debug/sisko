...
@section('content')
<div class="container">
    <h3 class="mb-4 text-center">Profil Orang Tua</h3>
            ...
            <div class="card shadow-sm border-0">
                <div class="card-body">
                    ...
                    <div class="text-center mb-3">
                        ...
                        <form action="{{ route('orangtua.profile.photo') }}" method="POST" enctype="multipart/form-data" class="d-flex justify-content-center mt-2">
                            @csrf
        ...
        <div class="col-md-5">
            <div class="card shadow-sm border-0 mb-4">
                <div class="card-body">
                    ...
                    <form action="{{ route('orangtua.profile.email') }}" method="POST">
                        @csrf
                        <div class="mb-3">
            ...
            <div class="card shadow-sm border-0">
                <div class="card-body">
                    ...
                    <form action="{{ route('orangtua.profile.password') }}" method="POST">
                        @csrf
                        <div class="mb-3">
